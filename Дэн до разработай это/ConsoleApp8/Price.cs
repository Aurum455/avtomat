namespace ConsoleApp8
{
    public class Price3
    {
        ...
        public void Print()
        {
            ...
            Console.WriteLine("______________________________________|");
            Console.WriteLine($"1.Короткий Лук {Price9}                    |");
            Console.WriteLine("______________________________________|");
            Console.WriteLine($"2.Длинный Лук {Price10}                     |");     
            Console.WriteLine("______________________________________|");
            Console.WriteLine($"3.Арбалет {Price11}                        |");
            Console.WriteLine("______________________________________|");
            Console.WriteLine($"4.Дротик (Метательное Копье) {Price12}       |");
            Console.WriteLine("______________________________________|");
